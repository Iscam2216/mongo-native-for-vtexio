...
echo "import * as mdb from '.'" > file.ts && $TSC --noEmit --traceResolution file.ts | grep 'mongodb-native-socks5.d.ts' && rm file.ts

npm i --no-save typescript@4.1.6
echo "Typescript $($TSC -v)"
$TSC --noEmit mongodb-native-socks5.ts3-4.d.ts
# check that resolution uses the downleveled types
echo "import * as mdb from '.'" > file.ts && $TSC --noEmit --traceResolution file.ts | grep 'mongodb-native-socks5.ts3-4.d.ts' && rm file.ts
